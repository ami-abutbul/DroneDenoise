...
from DroneDenoise.Utilities.file_utils import dir_to_file_list, dir_to_subdir_list
import os
import numpy as np
...
class TSPspeechHandler(object):
    def __init__(self):
        self.wav_dirs = dir_to_subdir_list(os.path.join(TSPspeech_path, '48k'))
    ...
    def get_noise(self):
        ...
        wav_data = np.array(wav_data).reshape([-1])
        return Fs, wav_data/2e5
